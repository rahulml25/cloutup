...
const Feed = () => {
	return (
		<div class="justify-center md:w-2/3 mx-auto px-2 md:px-8 overflow-y-auto scrollbar-hide">
		        <div class="flex mt-2.5 space-x-2">
		          <div class="relative cursor-pointer">
		            <img
		              src="./rahul.gif"
		              class="absolute m-1 p-0.5 h-10 bg-white rounded-full shadow z-[3]" alt=""
		            />
		            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 472.615 472.615"
		              class="absolute h-10 ml-6 mt-11 text-white hover:text-gray-200 z-[2]"
		              fill="currentColor" xml:space="preserve"> <g> <g> <polygon points="246.154,226.462 246.154,0 226.462,0 226.462,226.462 0,226.462 0,246.154 226.462,246.154 226.462,472.615 246.154,472.615 246.154,246.154 472.615,246.154 472.615,226.462 		"/> </g> </g> <g> </g> <g> </g> <g> </g> <g> </g> <g> </g> <g> </g> <g> </g> <g> </g> <g> </g> <g> </g> <g> </g> <g> </g> <g> </g> <g> </g> <g> </g>
		            </svg>
		            <img
		              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTMfWYBaBINACjw0Bmi1eFp4q9rHjZ5xnGRTQ&usqp=CAU"
		              class="h-32 rounded-xl hover:scale-[1.05] shadow-md z-[1]" alt=""
		            />
		          </div>
		          <div class="relative cursor-pointer">
		            <img
		        ...
		        <div class="mt-2.5 p-4 rounded-xl bg-white shadow">
		          <div class="flex items-center space-x-2">
		            <img
		              src="./rahul.gif"
		              class="h-8 w-8 rounded-full cursor-pointer"
		              alt=""/>
		            <div class="flex-1 p-2 rounded-full bg-gray-100">
		              <input type="text"
		                placeholder="What is in your mind, Rahul?"
		                class="px-2 w-full bg-transparent outline-none">
		            </div>
		          </div>
		
		          <div class="my-4 border-b"></div>
		
		          <div class="flex items-center justify-between md:justify-evenly space-x-2">
		            <button class="flex flex-1 p-2 md:p-4 items-center justify-center bg-gray-100 space-x-2 rounded-xl">
		              <svg width="24px" height="24px"
		                viewBox="0 0 24 24" version="1.1" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
		                fill="currentColor"
		              ...
		              <p class="text-sm md:text-normal">Live Video</p>
		            </button>
		            <button class="flex flex-1 p-2 md:p-4 items-center justify-center bg-gray-100 space-x-2 rounded-xl">
		              ...
		              <p class="text-sm md:text-normal">Photo / Video</p>
				  ...
				  C239.42,115.14,234.26,113,229,113z"/>
		              ...
		              <p class="text-sm md:text-normal">Filling / Activity</p>
		            </button>
		          </div>
		        </div>
		        ...
		        <div class="py-4 space-y-4">
		          <div>
		            <div class="p-3.5 bg-white rounded-xl shadow">
		              <div class="flex items-center justify-start">
		                <img
		                  src="./rahul.gif"
		                  class="h-8 w-8 rounded-full cursor-pointer"
		                  alt=""/>
		                <p class="ml-2 cursor-pointer">Rahul Mondal</p>
		              </div>
		              <div class="my-2">
		                <p>Rahul in sunset</p>
		              </div>
		              <div class="flex justify-center -mx-3.5 min-h-[10rem] bg-slate-100">
		                <img
		                  ...
		                  class="object-scale-down max-h-[40rem]" alt="">
		              </div>
		              <div class="flex mt-3.5 items-center justify-between md:justify-evenly space-x-2">
		                <button type="button"
		                  class="flex flex-1 p-2 pr-2.5 items-center justify-center space-x-1.5 text-gray-500 hover:text-blue-500 bg-gray-100 active:scale-[1.05] rounded-md">
		                ...
		                <button type="button"
		                  ...
		                  <svg width="24" height="24"
		                    ...
		                    viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><defs><style>.cls-1{fill:#41416e;}</style></defs><title>comment</title><g id="comment-Regular"><path id="comment-Regular-2" data-name="comment-Regular" class="cls-1" d="M17,3.25H7A4.756,4.756,0,0,0,2.25,8V21a.75.75,0,0,0,1.28.53l2.414-2.414a1.246,1.246,0,0,1,.885-.366H17A4.756,4.756,0,0,0,21.75,14V8A4.756,4.756,0,0,0,17,3.25ZM20.25,14A3.254,3.254,0,0,1,17,17.25H6.829a2.73,2.73,0,0,0-1.945.806L3.75,19.189V8A3.254,3.254,0,0,1,7,4.75H17A3.254,3.254,0,0,1,20.25,8Z"/></g>
		                  </svg>
		                  Comment
		                </button>
		                <button type="button"
		                  ...
		                  <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
		                    ...
		                    <path id="Rectangle" d="M12,4V0l8,7-8,7V10S0,9.069,0,14.737C0,3.4,12,4,12,4Z" transform="translate(2 5)" fill="none" stroke="currentColor" stroke-miterlimit="10" stroke-width="1.5"/>
		                  </svg>
		                  Share
		                </button>
		              </div>
